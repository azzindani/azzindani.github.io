...
1. Data Collection
   ...
   - Collection process
     ...
     <div align="center">
       ![diagram](uploads/images/projects/broker-transaction-automation/001.png)
       ![diagram](uploads/images/projects/broker-transaction-automation/002.png)
       ![diagram](uploads/images/projects/broker-transaction-automation/003.png)
     </div>
     
- Completion check
     
     ![diagram](uploads/images/projects/broker-transaction-automation/004.png)
     
- Recollection process
     
     ![diagram](uploads/images/projects/broker-transaction-automation/005.png)
...
2. Data Process
   ...
   - Data conversion by leveraging multiprocessing
     ...
     ![diagram](uploads/images/projects/broker-transaction-automation/006.png)
     
- Uploading dataset to SQL server
     
     ![diagram](uploads/images/projects/broker-transaction-automation/007.png)
     
- Result & preview
     
     ![diagram](uploads/images/projects/broker-transaction-automation/008.png)
     
   - Back up dataset as raw files
     
     ![diagram](uploads/images/projects/broker-transaction-automation/009.png)
...
3. Data Visualization
   ...
   <div align="center">
     ![diagram](uploads/images/projects/broker-transaction-automation/010.png)
     ![diagram](uploads/images/projects/broker-transaction-automation/011.png)
     ![diagram](uploads/images/projects/broker-transaction-automation/012.png)
     ![diagram](uploads/images/projects/broker-transaction-automation/013.png)
   </div>
