...
2. Labelling
   ...
   ![diagram](uploads/images/projects/lung-abnormalities-detection/001.png)
...
![diagram](uploads/images/projects/lung-abnormalities-detection/002.png)
...
4. Training Model using TensorFlow OD API
   ...
   - Generate the training command using this code.
    ...
    - Copy and paste the training command into the command prompt, then press enter to start the training process.
      ...
      ![diagram](uploads/images/projects/lung-abnormalities-detection/003.png)
      
- Training process

     ![diagram](uploads/images/projects/lung-abnormalities-detection/004.png)
...
- Once training is complete, you can check the trained model as shown below. This model can be used to perform various detection tasks.
     ...
     ![diagram](uploads/images/projects/lung-abnormalities-detection/005.png)
...
5. Detection Test
   ...
   <div align="center">
     ![diagram](uploads/images/projects/lung-abnormalities-detection/006.png)
     ![diagram](uploads/images/projects/lung-abnormalities-detection/007.png)
     ![diagram](uploads/images/projects/lung-abnormalities-detection/008.png)
     ![diagram](uploads/images/projects/lung-abnormalities-detection/009.png)
     ![diagram](uploads/images/projects/lung-abnormalities-detection/010.png)
     ![diagram](uploads/images/projects/lung-abnormalities-detection/011.png)
   </div>
