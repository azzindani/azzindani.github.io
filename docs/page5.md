...
3. Data Collection
   ...
   - If batch datasets are unavailable, develop a data collection process like web scraping.<br><br>

4. Data Preprocessing
   - Clean and sort relevant datasets.  
   - Handle missing data or outliers.  
   - Perform data augmentation.  
   - Split the data into training, validation, and test sets.<br><br>
...
5. Model Building
   ...
   - Set hyperparameters such as learning rate, batch size, and number of epochs.<br><br>
...
7. Fine-Tuning
   ...
   - Transfer Learning: Fine-tune pre-trained models on new datasets if the original task is similar.<br><br>
